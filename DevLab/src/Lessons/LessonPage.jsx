...
return subject !== "DataBase" ? (
    ...
    <div className="h-[83%] flex justify-around items-center p-4">
        ...
        dark:[&::-webkit-scrollbar-thumb]:bg-neutral-500">
            ...
            <>
                <h2 className="text-[2rem] font-bold text-shadow-lg text-shadow-black">{levelData.order}. {levelData.title}</h2>
    ...
    <div className="bg-[#191a26] h-[95%] w-[32%] rounded-2xl flex flex-col gap-3 items-center p-3 shadow-[0_5px_10px_rgba(147,_51,_234,_0.7)]">
        ...
        <div className="flex justify-around w-full">
            <button onClick={runCode} className="bg-[#9333EA] text-white font-bold rounded-xl p-3 w-[45%] hover:cursor-pointer">RUN</button>
