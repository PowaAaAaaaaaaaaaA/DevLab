...
function Register() {
    return (
        <div className="min-h-screen bg-[#0D1117] flex justify-center items-center">
                ...
                {/*------FORM-------*/}
                <form className='w-[100%] flex flex-col items-center p-3.5 gap-4'>
                {/*Email input*/}   
            ...
            <div className='w-[70%] flex justify-center relative '>
                    <input type="Password" name="" id="" placeholder='Confirm Password' className='relative bg-[#1E212F] text-[#FFFFFE] w-[100%] h-[5vh] rounded-2xl  pl-[50px] '/>
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" className=' absolute h-[50%] w-[10%] text-[white] left-0 top-3 pl-[10px]'>
                    <path stroke-linecap="round" stroke-linejoin="round" d="M16.5 10.5V6.75a4.5 4.5 0 1 0-9 0v3.75m-.75 11.25h10.5a2.25 2.25 0 0 0 2.25-2.25v-6.75a2.25 2.25 0 0 0-2.25-2.25H6.75a2.25 2.25 0 0 0-2.25 2.25v6.75a2.25 2.25 0 0 0 2.25 2.25Z" />
                    </svg>
            </div>
            ...
            <div className='w-[25%] flex relative self-start ml-[15%]'>
                <input type="number" name="" id="" placeholder='Age' className='relative bg-[#1E212F] text-[#FFFFFE] w-[100%] h-[5vh] rounded-2xl  pl-[50px] '/>
            ...
            <div className='m-[2%] w-[35%]'>
                    <button className='bg-[#7F5AF0] w-[100%] text-[1.2rem] rounded-4xl text-white p-4 font-bold hover:cursor-pointer'>Register</button>
            </div>        
            {/*------FORM END-------*/}        
                </form>
