  ...
  const [focused, setFocused] = useState(false);
        ...
        return (
            <div className="min-h-screen bg-[#0D1117] flex justify-center items-center">
                ...
                <h1 className="self-center font-exo text-[3.5rem] font-bold text-[#F5F5F5] block text-shadow-lg/80">DEVLAB</h1>
                </div>
                {/*right pannel*/}
                <div className="flex w-[50%] items-center flex-col">
                <img src={logIcon} alt="" className='w-50 h-50 mt-10'/>
                {/*Form*/}
                <form className='w-[100%] flex flex-col gap-5 items-center p-3.5' onSubmit={handleSubmit} autoComplete="off"    >
            <div className='w-[70%] flex justify-start items-center relative'>
                ...
                <div className='m-[2%] w-[35%]'>
                    <button className='bg-[#7F5AF0] w-[100%] text-[1.2rem] rounded-4xl text-white p-4 font-bold hover:cursor-pointer hover:bg-[#6A4CD4] hover:scale-105 transition duration-300 ease-in-out hover:drop-shadow-[0_0_6px_rgba(188,168,255,0.8)]'>Login</button>
                </div>      
                    {/*Form End*/}          
                    </form>
                    {/*right pannel End*/}
