...
console.log(lessonIds);
  ...
  const fetchProgress = async () => {
    ...
    const progressRef = collection(db, "Users", userId, "Progress", "Html", "Lessons", lessonIds, "Levels");
    const progressSnap = await getDocs(progressRef);
    const progress = {};
    progressSnap.forEach(doc => {
      progress[doc.id] = doc.data().status; // true or false
    });
...
useEffect(() => {
  ...
  return (
    <>
      ...
      const isUnlocked = userProgress[level.id];
