...
🚀 Run it before the timer hits zero!`}
    ...
    <div className="h-[83%] flex justify-around items-center p-4">
      ...
      dark:[&::-webkit-scrollbar-thumb]:bg-neutral-500">
        ...
        <div className="mt-4 p-4 bg-[#25293B] rounded-2xl flex flex-col gap-3">
                ...
                <p className='bg-[#191C2B] p-3 rounded-xl text-white overflow-auto whitespace-pre-wrap font-exo'>{lessonGamemode.preCode}</p>
        </div>
            </>) : <p>Loading...</p>}
        </div>
        {/* Code Editor */}
    <div className="bg-[#191a26] h-[95%] w-[32%] rounded-2xl flex flex-col gap-3 items-center p-3 shadow-[0_5px_10px_rgba(147,_51,_234,_0.7)]">
        ...
        <div className="flex justify-around w-full">
            <button onClick={runCode} className="bg-[#7F5AF0] text-white font-bold rounded-xl p-3 w-[45%] hover:cursor-pointer hover:bg-[#6A4CD4] hover:scale-101 transition duration-300 ease-in-out hover:drop-shadow-[0_0_6px_rgba(188,168,255,0.3)] ">RUN</button>
            <button className="bg-[#7F5AF0] text-white font-bold rounded-xl p-3 w-[45%] hover:cursor-pointer hover:bg-[#6A4CD4] hover:scale-101 transition duration-300 ease-in-out hover:drop-shadow-[0_0_6px_rgba(188,168,255,0.3)]">EVALUATE</button>
        </div>
    </div>
        {/* Output */}
...
<div className='h-screen bg-[#0D1117] flex flex-col'>
      ...
      dark:[&::-webkit-scrollbar-thumb]:bg-neutral-500">
        ...
        <div className='bg-[#191a26] h-[95%] w-[32%] rounded-2xl flex items-center justify-center flex-col p- shadow-[0_5px_10px_rgba(147,_51,_234,_0.7)]'>
            ...
            <div className='w-[100%] flex justify-around'> 
                <button  onClick={runCode} className="bg-[#7F5AF0] rounded-xl text-white  hover:cursor-pointer w-[30%] font-exo font-bold p-4 hover:bg-[#6A4CD4] hover:scale-101 transition duration-300 ease-in-out hover:drop-shadow-[0_0_6px_rgba(188,168,255,0.3)] ">RUN</button>
                <button  className=" bg-[#7F5AF0] rounded-xl text-white hover:cursor-pointer w-[30%] font-exo font-bold p-4 hover:bg-[#6A4CD4] hover:scale-101 transition duration-300 ease-in-out hover:drop-shadow-[0_0_6px_rgba(188,168,255,0.3)] ">EVALUATE</button>
            </div>
        </div>
    ...
    <div className=' border-2 border-t-white h-[7%] w-[100%] flex justify-between p-4 items-center'>
        ...
        <div className='w-[10%]'>
            <button  className=" bg-[#7F5AF0] rounded-xl text-white hover:cursor-pointer w-[100%] font-exo font-bold p-2  hover:bg-[#6A4CD4] hover:scale-101 transition duration-300 ease-in-out hover:drop-shadow-[0_0_6px_rgba(188,168,255,0.3)]">Next</button>
        </div>
        <div>
